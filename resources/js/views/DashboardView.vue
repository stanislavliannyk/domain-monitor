            ...
            <template v-else>
                ...
                <div class="card overflow-hidden">
                    ...
                    <div v-if="domains.length === 0" class="px-6 py-12 text-center text-gray-400">
                        <p>No domains yet.</p>
                        <RouterLink :to="{ name: 'domains.create' }" class="mt-2 inline-block text-blue-600 hover:underline text-sm">
...
const PlusIcon = {
    template: `<svg fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
